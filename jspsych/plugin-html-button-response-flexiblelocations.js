var jsPsychHtmlButtonResponseFlexiblelocations = (function (jspsych) {
  'use strict';
  ...
  const info = {
      ...
      parameters: {
        ...
        //   Ron added to allow assigning each button to a new block
          block_attribute: {
            type: jspsych.ParameterType.STRING,
            pretty_name: "Display",
          ...
          grid_attribute: {
            type: jspsych.ParameterType.BOOL,
            pretty_name: "Display buttons in grid",
            default: false,
          },
      },
  };
  ...
  class HtmlButtonResponsePlugin {
      ...
      trial(display_element, trial) {
        ...
        // ron changed to grid format
        if (trial.grid_attribute) {
            html += '<div id="jspsych-html-button-response-btngroup" style="display: grid; grid-template-columns: auto auto;">';
        } else {html += '<div id="jspsych-html-button-response-btngroup">';}
          
          for (var i = 0; i < trial.choices.length; i++) {
              var str = buttons[i].replace(/%choice%/g, trial.choices[i]);
              html +=
                  '<div class="jspsych-html-button-response-button" style="display:'+trial.block_attribute[i]+'; margin:' +
