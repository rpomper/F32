var jsPsychAudioButtonResponseFlexiblelocations = (function (jspsych) {
  'use strict';
      ...
      trial(display_element, trial, on_load) {
          ...
          const setupTrial = () => {
            ...
            if (trial.grid_attribute) {
                var html = '<div id="jspsych-audio-button-response-btngroup" style="display: grid; grid-template-columns: auto auto;">';
            } else {var html = '<div id="jspsych-audio-button-response-btngroup">';}

              for (var i = 0; i < trial.choices.length; i++) {
                  var str = buttons[i].replace(/%choice%/g, trial.choices[i]);
                  html +=
                      '<div class="jspsych-audio-button-response-button" style="display:'+trial.block_attribute[i]+'; margin:' +
